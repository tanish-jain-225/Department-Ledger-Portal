...
function getAdminApp() {
  ...
  // In production use a server-only project ID and standard Google service account
  // credentials via GOOGLE_APPLICATION_CREDENTIALS or the runtime environment.

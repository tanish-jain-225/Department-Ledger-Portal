    ...
    <ToastContext.Provider value={{ addToast, dismissToast }}>
      ...
      >
        {toasts.map((t) => (
          <div
            key={t.id}
            className={`pointer-events-auto flex items-start gap-4 rounded-2xl border-2 px-5 py-4 shadow-[0_8px_32px_rgba(0,0,0,0.08)] backdrop-blur-xl transition-all duration-500 ${
              t.removing
              ...
              t.variant === "success"
                ...
                : "border-brand-200/50 bg-brand-50/80 text-brand-900"
            }`}

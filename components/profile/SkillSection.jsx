  ...
  return (
    <div className="flex flex-col gap-8 animate-fade-in">
      ...
      <div className="flex flex-col gap-3 bg-slate-50/50 p-4 sm:p-5 rounded-2xl border border-slate-100">
        ...
        <SmartAssistant mode="skill" existingData={rows}
          onExtract={(d) => {
      ...
      <ConfirmDialog
        ...
        onConfirm={async () => {
          try {
            await removeRecord("skills", deleteTarget.id, { actorUid: uid, description: `Removed: ${deleteTarget.name}` });
            addToast("Skill entry erased", "success");
            onRefresh();
          } catch { addToast("Failed to remove skill", "error"); }

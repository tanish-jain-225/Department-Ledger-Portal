    ...
    <Layout title="Student Hub" access={ACCESS.STUDENT}>
      ...
      <div className="flex min-h-[70vh] flex-col items-center justify-center py-12 animate-fade-in">
        ...
        <div className="grid gap-10 sm:grid-cols-2 w-full max-w-5xl px-6">
          ...
          >
            <div className="mb-8 flex h-24 w-24 items-center justify-center rounded-[2rem] bg-brand-50 text-brand-700 group-hover:bg-brand-700 group-hover:text-white group-hover:rotate-6 transition-all shadow-xl shadow-brand-500/10 border border-brand-100">
